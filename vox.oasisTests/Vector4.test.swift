...
class Vector4Tests: XCTestCase {
    ...
    func testStaticAdd() {
        ...
        Vector4.add(left: a, right: b, out: out)
    ...
    func testStaticSubtract() {
        ...
        Vector4.subtract(left: a, right: b, out: out)
    ...
    func testStaticMultiply() {
        ...
        Vector4.multiply(left: a, right: b, out: out)
    ...
    func testStaticDivide() {
        ...
        Vector4.divide(left: a, right: b, out: out)
    ...
    func testStaticLerp() {
        ...
        Vector4.lerp(left: a, right: b, t: 0.5, out: out)
        XCTAssertEqual(out.x, 1)
    ...
    func testStaticMax() {
        ...
        Vector4.max(left: a, right: b, out: out)
    ...
    func testStaticMin() {
        ...
        Vector4.min(left: a, right: b, out: out)
    ...
    func testStaticNormalize() {
        ...
        Vector4.normalize(left: a, out: out)
    ...
    func testStaticScale() {
        ...
        Vector4.scale(left: a, s: 3, out: out)
    ...
    func testStaticTransform() {
        ...
        Vector4.transform(v: a, m: m4, out: out)
        XCTAssertEqual(out.x, 2)
        XCTAssertEqual(out.y, 3)
        XCTAssertEqual(out.z, 9)
        XCTAssertEqual(out.w, 0)

        Vector4.transformByQuat(v: a, q: Quaternion(), out: out)
        XCTAssertEqual(out.x, a.x)
        XCTAssertEqual(out.y, a.y)
        XCTAssertEqual(out.z, a.z)
        XCTAssertEqual(out.w, a.w)

        Vector4.transformByQuat(v: a, q: Quaternion(2, 3, 4, 5), out: out)
