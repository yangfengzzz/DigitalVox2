...
class SphericalHarmonics3 {
    ...
    func addLight(direction: Vector3, color: Color, deltaSolidAngle: Float) {
        /**
        ...
        _ = color.scale(s: deltaSolidAngle)
    ...
    ///   - out: Out color
    /// - Returns: Out color
    func evaluate(direction: Vector3, out: Color) -> Color {
        /**
        ...
        _ = out.setValue(r: r, g: g, b: b, a: 1.0)
        return out
    }
    ...
    func setValueByArray(array: [Float], offset: Int = 0) {
...
extension SphericalHarmonics3: IClone {
    typealias Object = SphericalHarmonics3

    func clone() -> SphericalHarmonics3 {
        let v = SphericalHarmonics3()
        cloneTo(target: v)

        return v
    }

    func cloneTo(target: SphericalHarmonics3) {
        toArray(out: &target.coefficients)
    }
}
