...
class MatrixTests: XCTestCase {
    ...
    func testStaticLerp() {
        ...
        let b = Matrix(m11: 1, m12: 2, m13: 3, m14: 4,
                ...
                m41: 13, m42: 14, m43: 15, m44: 16)
        let c = Matrix()
        Matrix.lerp(start: a, end: b, t: 0.7, out: c)
    ...
    func testStaticRotationQuaternion() {
        ...
        Matrix.rotationQuaternion(quaternion: q, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
    ...
    func testStaticRotationAxisAngle() {
        ...
        Matrix.rotationAxisAngle(axis: Vector3(0, 1, 0), r: Float.pi / 3, out: out)
        XCTAssertEqual(
                Matrix.equals(
    ...
    func testStaticRotationTranslation() {
        ...
        Matrix.rotationTranslation(quaternion: q, translation: v, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
    ...
    func testStaticAffineTransformation() {
        ...
        Matrix.affineTransformation(scale: s, rotation: q, translation: v, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
                right: Matrix(m11: -7.5, m12: 5, m13: 3, m14: 0,
    ...
    func testStaticScaling() {
        ...
        Matrix.scale(m: a, s: Vector3(1, 2, 0.5), out: out)
        XCTAssertEqual(Matrix.equals(left: out,
    ...
    func testStaticTranslation() {
        ...
        Matrix.translation(translation: v, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
                right: Matrix(m11: 1, m12: 0, m13: 0, m14: 0,
                        m21: 0, m22: 1, m23: 0, m24: 0,
    ...
    func testStaticLookAt() {
        let out = Matrix()
        let eye = Vector3(0, 0, -8)
        let target = Vector3(0, 0, 0)
        let up = Vector3(0, 1, 0)

        Matrix.lookAt(eye: eye, target: target, up: up, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
                right: Matrix(m11: -1, m12: 0, m13: 0, m14: 0,
                        m21: 0, m22: 1, m23: 0, m24: 0,
                        m31: 0, m32: 0, m33: -1, m34: 0,
    ...
    func testStaticOrtho() {
        let out = Matrix()
        Matrix.ortho(left: 0, right: 2, bottom: -1, top: 1, near: 0.1, far: 100, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
                right: Matrix(m11: 1, m12: 0, m13: 0, m14: 0,
                        m21: 0, m22: 1, m23: 0, m24: 0,
    ...
    func testStaticPerspective() {
        let out = Matrix()
        Matrix.perspective(fovy: 1, aspect: 1.5, near: 0.1, far: 100, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
    ...
    func testStaticRotateAxisAngle() {
        ...
        Matrix.rotateAxisAngle(m: a, axis: Vector3(0, 1, 0), r: Float.pi / 3, out: out)
        XCTAssertEqual(Matrix.equals(left: out,
    ...
    func testStaticTranslate() {
        ...
        Matrix.translate(m: a, v: Vector3(1, 2, 0.5), out: out)
        XCTAssertEqual(Matrix.equals(left: out,
