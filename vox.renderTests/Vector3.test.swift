...
class Vector3Tests: XCTestCase {
    ...
    func testStaticSubtract() {
        ...
        Vector3.subtract(left: a, right: b, out: out)
    ...
    func testStaticMultiply() {
        ...
        Vector3.multiply(left: a, right: b, out: out)
    ...
    func testStaticDivide() {
        ...
        Vector3.divide(left: a, right: b, out: out)
    ...
    func testStaticCross() {
        ...
        Vector3.cross(left: a, right: b, out: out)
    ...
    func testStaticLerp() {
        ...
        Vector3.lerp(left: a, right: b, t: 0.5, out: out)
        XCTAssertEqual(out.x, 1)
    ...
    func testStaticMax() {
        ...
        Vector3.max(left: a, right: b, out: out)
    ...
    func testStaticMin() {
        ...
        Vector3.min(left: a, right: b, out: out)
    ...
    func testStaticNormalize() {
        ...
        Vector3.normalize(left: a, out: out)
    ...
    func testStaticScale() {
        ...
        Vector3.scale(left: a, s: 3, out: out)
    ...
    func testStaticTransform() {
        ...
        Vector3.transformNormal(v: a, m: m44, out: out)
        ...
        Vector3.transformCoordinate(v: a, m: m4, out: out)
        Vector4.transform(v: b, m: m4, out: out4)
        XCTAssertEqual(out.x, out4.x / out4.w)
        XCTAssertEqual(out.y, out4.y / out4.w)
        XCTAssertEqual(out.z, out4.z / out4.w)

        Vector3.transformByQuat(v: a, quaternion: Quaternion(), out: out)
        XCTAssertEqual(out.x, a.x)
        XCTAssertEqual(out.y, a.y)
        XCTAssertEqual(out.z, a.z)

        Vector3.transformByQuat(v: a, quaternion: Quaternion(2, 3, 4, 5), out: out)
